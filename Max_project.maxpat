...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 281.0, 89.0, 154.0, 60.0 ],
					"style" : "",
					"text" : "I'm confused at this point, how can i set an image as the background instead of a color?"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 551.0, 380.0, 150.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 531.0, 360.0, 150.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 622.0, 415.5, 69.0, 23.0 ],
					"style" : "",
					"text" : "brgb 0 0 0"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 82.5, 117.0, 337.0, 21.0 ],
									"style" : "",
									"text" : "Subpatch from Max 7 help"
								}
...
,
					"patching_rect" : [ 394.0, 645.5, 59.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 746.0, 463.5, 171.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 698.0, 369.5, 287.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 650.0, 466.5, 91.0, 23.0 ],
					"style" : "",
					"text" : "pensize 10 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 73.0, 218.5, 71.0, 23.0 ],
					"style" : "",
					"text" : "qmetro 30"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 73.0, 181.5, 71.0, 23.0 ],
					"style" : "",
					"text" : "t i clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 73.0, 152.5, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 73.0, 645.5, 55.0, 36.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 409.0, 160.0, 206.0, 23.0 ],
					"style" : "",
					"text" : "readpict myimage KidsMaze18.gif"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 181.5, 182.0, 40.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.0, 192.0, 40.0, 23.0 ],
					"style" : "",
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 73.0, 366.0, 134.0, 23.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 418.5, 357.0, 82.5, 357.0 ],
					"source" : [ "obj-129", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-98", 0 ],
					"midpoints" : [ 631.5, 438.0, 405.0, 438.0, 405.0, 360.0, 82.5, 360.0 ],
					"source" : [ "obj-133", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-98", 0 ],
					"midpoints" : [ 403.5, 693.0, 60.0, 693.0, 60.0, 360.0, 82.5, 360.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-98", 0 ],
					"midpoints" : [ 134.5, 211.5, 62.833336, 211.5, 62.833336, 336.5, 82.5, 336.5 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-98", 0 ],
					"midpoints" : [ 659.5, 492.0, 405.0, 492.0, 405.0, 360.0, 82.5, 360.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-98", 0 ],
					"midpoints" : [ 157.5, 288.0, 82.5, 288.0 ],
					"source" : [ "obj-90", 0 ]
				}
